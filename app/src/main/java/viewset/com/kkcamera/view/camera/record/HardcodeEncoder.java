...
import viewset.com.kkcamera.view.camera.multimedia.MediaAudioEncoder;
import viewset.com.kkcamera.view.camera.multimedia.MediaEncoder;
import viewset.com.kkcamera.view.camera.multimedia.MediaMuxerWrapper;
import viewset.com.kkcamera.view.camera.multimedia.MediaVideoEncoder;
...
public final class HardcodeEncoder {
    ...
    private static class RecordThread extends Thread {
        ...
        private void initRecordingFilter(Context context) {
            if (mShowFilter == null) {
                mShowFilter = new NoFilter(context);
            }
            mShowFilter.setSize(mVideoWidth, mVideoHeight);
        }
