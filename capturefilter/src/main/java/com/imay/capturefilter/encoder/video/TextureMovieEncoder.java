...
package com.imay.capturefilter.encoder.video;
...
import com.imay.capturefilter.encoder.gles.EglCore;
...
import com.imay.capturefilter.filter.helper.MagicFilterFactory;
...
public class TextureMovieEncoder implements Runnable {
    ...
    private void handleUpdateSharedContext(EGLContext newSharedContext) {
        ...
        mInput.init();
        filter = MagicFilterFactory.initFilters(mContext.getApplicationContext(), type);
        if (filter != null) {
            filter.init();
