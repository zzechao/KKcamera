...
public class IFBrannanFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.mipmap.brannan_process);
        addInputTexture(R.mipmap.brannan_blowout);
        addInputTexture(R.mipmap.brannan_contrast);
        addInputTexture(R.mipmap.brannan_luma);
        addInputTexture(R.mipmap.brannan_screen);
    }
}
