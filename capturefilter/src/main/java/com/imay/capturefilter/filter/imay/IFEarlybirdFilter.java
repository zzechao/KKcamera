...
public class IFEarlybirdFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.mipmap.earlybird_curves);
        addInputTexture(R.mipmap.earlybird_overlay_map);
        addInputTexture(R.mipmap.vignette_map);
        addInputTexture(R.mipmap.earlybird_blowout);
        addInputTexture(R.mipmap.earlybird_map);
    }
}
