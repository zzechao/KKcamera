...
public class IFHefeFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.mipmap.edge_burn);
        addInputTexture(R.mipmap.hefe_map);
        addInputTexture(R.mipmap.hefe_gradient_map);
        addInputTexture(R.mipmap.hefe_soft_light);
        addInputTexture(R.mipmap.hefe_metal);
    }
}
