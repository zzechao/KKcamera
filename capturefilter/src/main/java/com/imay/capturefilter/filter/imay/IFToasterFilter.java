...
public class IFToasterFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.mipmap.toaster_metal);
        addInputTexture(R.mipmap.toaster_soft_light);
        addInputTexture(R.mipmap.toaster_curves);
        addInputTexture(R.mipmap.toaster_overlay_map_warm);
        addInputTexture(R.mipmap.toaster_color_shift);
    }
}
